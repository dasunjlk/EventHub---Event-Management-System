...
const Navbar = () => {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              to="/login"
              id="nav-login-btn"
              className="glass-btn text-sm py-2 px-6"
            >
              Login
            </Link>
          </div>
      ...
      >
        <div className="px-4 pb-4 flex flex-col gap-3 bg-white/10 backdrop-blur-2xl border-t border-white/10 rounded-b-2xl shadow-xl">
          ...
          <Link
            to="/login"
            id="mobile-nav-login"
            className="glass-btn text-sm py-2.5 text-center mt-2 w-full"
          >
            Login
          </Link>
        </div>
