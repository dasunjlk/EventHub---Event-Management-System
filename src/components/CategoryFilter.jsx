export default function CategoryFilter({ categories = ['All', 'Music', 'Tech', 'Art', 'Education', 'Workshop'], selectedCategory, onSelectCategory }) {
  return (
        ...
        <button
          ...
          className={`px-5 py-2 rounded-full text-sm font-semibold border transition-all duration-200 shadow-sm ${
            selectedCategory === cat
              ? 'bg-primary-600 border-primary-500 text-white shadow-primary-900/30 -translate-y-0.5'
